...
import (
	...
	cachecmd "github.com/jcrussell/solvent-streets/pkg/cmd/cache"
	"github.com/jcrussell/solvent-streets/pkg/cmd/checksite"
...
func addSubcommands(cmd *cobra.Command, f *cmdutil.Factory) {
	...
	addGroupedCommand(cmd, cachecmd.NewCmdCache(f), groupInfo)
	addGroupedCommand(cmd, checksite.NewCmdCheckSite(f, nil), groupInfo)
