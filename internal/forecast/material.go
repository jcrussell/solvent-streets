...
// its own mix designs. Sidewalks are concrete, not asphalt — a future
// DefaultSidewalkMaterialTiers (cement/aggregate) can parallel this the way
// DefaultSidewalkCostTiers parallels DefaultCostTiers.
